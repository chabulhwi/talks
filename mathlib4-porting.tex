...
% If you want to use XeLaTeX to compile this document,
% comment out the four lines below and set the fonts you will use.
...
\begin{frame}{한국에는 형식 수학이 없다}
  \begin{itemize}
    ...
    \item 그나마 KAIST 수리과학과 엄상일 교수님이 린에 관심을 보임
